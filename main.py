...
canvas.title("TuneWave")           # Title of the MP3_Player
...
# play_Button text is Unpause then the play button will just resume the paused song and change the text of play_Button
# to Play
def select():
...
# tk.Label is used to make a display box where one can place text or images
